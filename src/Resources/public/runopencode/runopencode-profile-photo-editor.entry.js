...
const image = (h("svg", { version: "1.1", xmlns: "http://www.w3.org/2000/svg", width: "48", height: "48", viewBox: "0 0 32 32" },
    h("path", { d: "M29.996 4c0.001 0.001 0.003 0.002 0.004 0.004v23.993c-0.001 0.001-0.002 0.003-0.004 0.004h-27.993c-0.001-0.001-0.003-0.002-0.004-0.004v-23.993c0.001-0.001 0.002-0.003 0.004-0.004h27.993zM30 2h-28c-1.1 0-2 0.9-2 2v24c0 1.1 0.9 2 2 2h28c1.1 0 2-0.9 2-2v-24c0-1.1-0.9-2-2-2v0z" }),
    h("path", { d: "M26 9c0 1.657-1.343 3-3 3s-3-1.343-3-3 1.343-3 3-3 3 1.343 3 3z" }),
    h("path", { d: "M28 26h-24v-4l7-12 8 10h2l7-6z" })));
const edit = (h("svg", { version: "1.1", xmlns: "http://www.w3.org/2000/svg", width: "32", height: "32", viewBox: "0 0 32 32" },
    h("path", { d: "M27 0c2.761 0 5 2.239 5 5 0 1.126-0.372 2.164-1 3l-2 2-7-7 2-2c0.836-0.628 1.874-1 3-1zM2 23l-2 9 9-2 18.5-18.5-7-7-18.5 18.5zM22.362 11.362l-14 14-1.724-1.724 14-14 1.724 1.724z" })));
const rotateRight = (h("svg", { version: "1.1", xmlns: "http://www.w3.org/2000/svg", width: "24", height: "28", viewBox: "0 0 24 28" },
    h("path", { d: "M24 4v7c0 0.547-0.453 1-1 1h-7c-0.406 0-0.766-0.25-0.922-0.625-0.156-0.359-0.078-0.797 0.219-1.078l2.156-2.156c-1.469-1.359-3.406-2.141-5.453-2.141-4.406 0-8 3.594-8 8s3.594 8 8 8c2.484 0 4.781-1.125 6.312-3.109 0.078-0.109 0.219-0.172 0.359-0.187 0.141 0 0.281 0.047 0.391 0.141l2.141 2.156c0.187 0.172 0.187 0.469 0.031 0.672-2.281 2.75-5.656 4.328-9.234 4.328-6.609 0-12-5.391-12-12s5.391-12 12-12c3.078 0 6.062 1.234 8.266 3.313l2.031-2.016c0.281-0.297 0.719-0.375 1.094-0.219 0.359 0.156 0.609 0.516 0.609 0.922z" })));
const rotateLeft = (h("svg", { version: "1.1", xmlns: "http://www.w3.org/2000/svg", width: "24", height: "28", viewBox: "0 0 24 28" },
    h("path", { d: "M24 14c0 6.609-5.391 12-12 12-3.578 0-6.953-1.578-9.234-4.328-0.156-0.203-0.141-0.5 0.031-0.672l2.141-2.156c0.109-0.094 0.25-0.141 0.391-0.141 0.141 0.016 0.281 0.078 0.359 0.187 1.531 1.984 3.828 3.109 6.312 3.109 4.406 0 8-3.594 8-8s-3.594-8-8-8c-2.047 0-3.984 0.781-5.437 2.141l2.141 2.156c0.297 0.281 0.375 0.719 0.219 1.078-0.156 0.375-0.516 0.625-0.922 0.625h-7c-0.547 0-1-0.453-1-1v-7c0-0.406 0.25-0.766 0.625-0.922 0.359-0.156 0.797-0.078 1.078 0.219l2.031 2.016c2.203-2.078 5.187-3.313 8.266-3.313 6.609 0 12 5.391 12 12z" })));
const rotate = (h("svg", { version: "1.1", xmlns: "http://www.w3.org/2000/svg", width: "28", height: "28", viewBox: "0 0 32 32" },
    h("path", { d: "M5.319 12.44c-0.184-0.602-0.284-1.242-0.284-1.905 0-3.59 2.91-6.5 6.5-6.5 0.663 0 1.302 0.099 1.905 0.284v0l-2.612-2.612 0.707-0.707 3.536 3.536-1.036 1.036v0.064c-0.014-0.007-0.028-0.014-0.043-0.022l-2.457 2.457-0.707-0.707 2.14-2.14c-0.457-0.123-0.937-0.189-1.433-0.189-3.038 0-5.5 2.462-5.5 5.5 0 0.496 0.066 0.976 0.189 1.433l2.14-2.14 0.707 0.707-2.457 2.457c0.007 0.014 0.014 0.028 0.022 0.043h-0.064l-1.036 1.036-3.536-3.536 0.707-0.707 2.612 2.612zM23.036 6.526c0-0.823-0.666-1.491-1.5-1.491-0.828 0-1.5 0.676-1.5 1.491v11.509h-1v-9.491c0-0.833-0.666-1.509-1.5-1.509-0.828 0-1.5 0.666-1.5 1.509v10.29c-2.058-2.2-4.768-4.619-5.879-3.503-1.087 1.093 1.714 4.105 5.626 10.687 1.763 2.966 3.993 5.016 7.753 5.017 4.142 0 7.5-3.358 7.5-7.5v-7.994c0-0.832-0.666-1.506-1.5-1.506-0.828 0-1.5 0.676-1.5 1.506v2.494h-1v-3.509c0-0.824-0.666-1.491-1.5-1.491-0.828 0-1.5 0.663-1.5 1.491v2.509h-1v-10.509z" })));
const move = (h("svg", { version: "1.1", xmlns: "http://www.w3.org/2000/svg", width: "28", height: "28", viewBox: "0 0 28 28" },
    ...
    render() {
        return [
            h("div", { id: "editor", class: this._mode },
                ...
                h("div", { id: "placeholder", class: this.isModePreview() && !this.isPreviewable() ? '' : 'hidden' }, this.placeholder ? h("img", { src: this.placeholder }) : image),
                ...
                h("span", { id: "action-edit", class: this.isModePreview() ? '' : 'hidden', onClick: () => this.execCommandEdit() }, edit),
        ...
        tools.forEach((tool) => {
            ...
            switch (tool) {
                case 'separator':
                    ...
                    break;
                case 'move':
                    elements.push(h("span", { class: this.isModeMove() ? 'active' : '', onClick: () => this.execCommandMove() }, move));
                    break;
                case 'crop':
                    elements.push(h("span", { class: this.isModeCrop() ? 'active' : '', onClick: () => this.execCommandCrop() }, crop));
                    break;
                case 'rotate':
                    elements.push(h("span", { class: this.isModeRotate() ? 'active' : '', onClick: () => this.execCommandRotate() }, rotate));
                    break;
                case 'rotate-left':
                    elements.push(h("span", { onClick: () => this.execCommandRotateLeft() }, rotateLeft));
                    break;
                case 'rotate-right':
                    elements.push(h("span", { onClick: () => this.execCommandRotateRight() }, rotateRight));
                    break;
                case 'flip-horizontal':
                    elements.push(h("span", { onClick: () => this.execCommandFlipHorizontal() }, flipHorizontal));
                    break;
                case 'flip-vertical':
                    elements.push(h("span", { onClick: () => this.execCommandFlipVertical() }, flipVertical));
                    break;
                case 'apply':
                    elements.push(h("span", { onClick: () => this.execCommandApply() }, apply));
                    break;
                case 'cancel':
                    elements.push(h("span", { onClick: () => this.execCommandCancel() }, cancel));
                    break;
                default:
